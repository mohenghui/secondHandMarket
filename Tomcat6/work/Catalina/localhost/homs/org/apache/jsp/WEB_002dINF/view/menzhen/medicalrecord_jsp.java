...
public final class medicalrecord_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	*=====================================================================**/
	...
	pageContext.setAttribute("path",path);
      ...
      out.write("<html>\r\n");
      out.write("  <head>\r\n");
      out.write("    <title>病历主页</title>\r\n");
      out.write("    \r\n");
      out.write("    <script type=\"text/javascript\">\r\n");
      out.write("    \r\n");
      out.write("    \t// 条件搜索\r\n");
      out.write("\t\tfunction searchMedicalrecord(){\r\n");
      out.write("    \t\t$('#dg').datagrid('load',{\r\n");
      out.write("    \t\t\tdeptid:$('#s_deptid').combobox(\"getValue\"),\r\n");
      out.write("    \t\t\tname:$('#s_name').val(),\r\n");
      out.write("    \t\t\tdoctor:$('#s_doctor').val(),\r\n");
      out.write("    \t\t\tphone:$('#s_phone').val()\r\n");
      out.write("    \t\t});\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("\t\tvar url;\r\n");
      out.write("\r\n");
      out.write("\t\t// 打开新增\r\n");
      out.write("        function openMedicalrecordAddDialog(){\r\n");
      out.write("        \t$(\"#dlg\").dialog(\"open\").dialog(\"setTitle\",\"添加信息\");\r\n");
      out.write("        \turl = 'reserveMedicalrecord.htm';\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("\t\t// 打开修改\r\n");
      out.write("        function openMedicalrecordUpdateDialog(){\r\n");
      ...
      out.write("    \t\turl=\"reserveMedicalrecord.htm?id=\"+row.id;\r\n");
      out.write("    \t}\r\n");
      out.write("\r\n");
      out.write("        // 保存\r\n");
      out.write("        function reserveMedicalrecord(){\r\n");
      out.write("        \tif($(\"#deptid\").val()==null || $(\"#deptid\").val().length==0){\r\n");
      ...
      out.write("    \t\t\t\t\tcloseMedicalrecordDialog();\r\n");
      ...
      out.write("\r\n");
      out.write("        // 关闭添加修改对话框\r\n");
      out.write("        function closeMedicalrecordDialog(){\r\n");
      ...
      out.write("\t\r\n");
      out.write("    \t// 删除科室\r\n");
      out.write("    \tfunction deleteMedicalrecord(){\r\n");
      out.write("    \t\tvar selectedRows=$(\"#dg\").datagrid('getSelections');\r\n");
      ...
      out.write("    \t\t\tif(r){\r\n");
      out.write("    \t\t\t\t$.post(\"deleteMedicalrecord.htm\",{ids:ids},function(result){\r\n");
      ...
      out.write("   \t\t\t\t pagination=\"true\" rownumbers=\"true\" url=\"medicalrecordList.htm\" fit=\"true\" toolbar=\"#tb\"\r\n");
      out.write("   \t\t\t\t \r\n");
      ...
      out.write("                \t<th field=\"phone\" width=\"60\" align=\"center\">手机号</th>\r\n");
      ...
      out.write("                \t<th field=\"doctor\" width=\"60\" align=\"center\">主治医生</th>\r\n");
      out.write("                \t<th field=\"remarks\" width=\"60\" align=\"center\">概述</th>\r\n");
      out.write("            \t</tr>\r\n");
      out.write("        </thead>\r\n");
      out.write("</table>\r\n");
      out.write("    \t\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t<div class=\"updownInterval\"> </div>\r\n");
      out.write("\t姓名：<input id=\"s_name\" />    &nbsp;&nbsp;手机号：<input id=\"s_phone\" /> &nbsp;&nbsp;医生：<input id=\"s_doctor\" /> &nbsp;&nbsp;\r\n");
      ...
      out.write("\t<a href=\"javascript:searchMedicalrecord()\" class=\"easyui-linkbutton\" iconCls=\"icon-search\" >搜索</a>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("  \t\t<tr>\r\n");
      out.write("  \t\t\t<td>医生</td>\r\n");
      out.write("  \t\t\t<td><input type=\"text\" id=\"doctor\" name=\"doctor\" class=\"easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("  \t\t</tr>\r\n");
      out.write("  \t\t\r\n");
      out.write("  \t\t<tr>\r\n");
      out.write("  \t\t\t<td>科室</td>\r\n");
      ...
      out.write("\t<a href=\"javascript:reserveMedicalrecord()\" class=\"easyui-linkbutton\" iconCls=\"icon-ok\">保存</a>\r\n");
      out.write("\t<a href=\"javascript:closeMedicalrecordDialog()\" class=\"easyui-linkbutton\" iconCls=\"icon-cancel\">关闭</a>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_privilege_005foperation_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/view/menzhen/medicalrecord.jsp(135,2) name = operationId type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_privilege_005foperation_005f0.setOperationId("100025");
    // /WEB-INF/view/menzhen/medicalrecord.jsp(135,2) name = clazz type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_privilege_005foperation_005f0.setClazz("easyui-linkbutton");
    // /WEB-INF/view/menzhen/medicalrecord.jsp(135,2) name = onClick type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_privilege_005foperation_005f0.setOnClick("openMedicalrecordAddDialog()");
    // /WEB-INF/view/menzhen/medicalrecord.jsp(135,2) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_privilege_005foperation_005f0.setName("添加");
    // /WEB-INF/view/menzhen/medicalrecord.jsp(135,2) name = iconCls type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_privilege_005foperation_005f1(PageContext _jspx_page_context)
    ...
    // /WEB-INF/view/menzhen/medicalrecord.jsp(136,2) name = operationId type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_privilege_005foperation_005f1.setOperationId("100026");
    // /WEB-INF/view/menzhen/medicalrecord.jsp(136,2) name = clazz type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_privilege_005foperation_005f1.setClazz("easyui-linkbutton");
    // /WEB-INF/view/menzhen/medicalrecord.jsp(136,2) name = onClick type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_privilege_005foperation_005f1.setOnClick("openMedicalrecordUpdateDialog()");
    // /WEB-INF/view/menzhen/medicalrecord.jsp(136,2) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_privilege_005foperation_005f1.setName("修改");
    // /WEB-INF/view/menzhen/medicalrecord.jsp(136,2) name = iconCls type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_privilege_005foperation_005f2(PageContext _jspx_page_context)
    ...
    // /WEB-INF/view/menzhen/medicalrecord.jsp(137,2) name = operationId type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_privilege_005foperation_005f2.setOperationId("100027");
    // /WEB-INF/view/menzhen/medicalrecord.jsp(137,2) name = clazz type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_privilege_005foperation_005f2.setClazz("easyui-linkbutton");
    // /WEB-INF/view/menzhen/medicalrecord.jsp(137,2) name = onClick type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_privilege_005foperation_005f2.setOnClick("deleteMedicalrecord()");
    // /WEB-INF/view/menzhen/medicalrecord.jsp(137,2) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_privilege_005foperation_005f2.setName("删除");
    // /WEB-INF/view/menzhen/medicalrecord.jsp(137,2) name = iconCls type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
